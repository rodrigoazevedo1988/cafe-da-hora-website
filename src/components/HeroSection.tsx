...
const HeroSection = () => {
  ...
  return (
    <section
      ...
      role="banner"
      style={{
        backgroundImage: `linear-gradient(rgba(139,69,19,0.5), rgba(139,69,19,0.3)), url('https://images.unsplash.com/photo-1509042239860-f550ce710b93?auto=format&fit=crop&w=1920&q=80')`,
    ...
    >
      ...
      <div className="relative z-10 container mx-auto px-4 sm:px-6 lg:px-8 text-center">
        <h1 className="font-playfair text-4xl sm:text-5xl lg:text-6xl xl:text-7xl font-bold text-white drop-shadow-lg mb-6 animate-text-glow">
          <span className="inline-block opacity-0 animate-fade-in" style={{ animationFillMode: 'forwards', animationDelay: '0.1s' }}>O melhor café que você poderia tomar</span>
        </h1>
