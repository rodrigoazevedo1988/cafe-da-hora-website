...
// URLs de fotos reais estáticas, cada uma relativa a seu produto:
const productsData = [
  {
    id: 1,
  ...
  },
  {
    ...
    price: 8.5,
    image: 'https://images.unsplash.com/photo-1561047029-3000e62f0c81?auto=format&fit=crop&w=400&q=80',
  },
];
        ...
        {productsData.map((prod, idx) => (
          ...
          >
            <img
              ...
              width={400}
              height={192}
              onError={e => (e.currentTarget.src = 'https://images.unsplash.com/photo-1506744038136-46273834b3fb?auto=format&fit=crop&w=400&q=80')}
            />
            <div className="p-6 flex flex-col gap-2">
              ...
              <div className="flex justify-between items-center mt-auto">
                ...
                <Button
                  className="flex items-center bg-coffee-500 hover:bg-coffee-600 text-white px-6 py-2 rounded-full transition-all duration-300 hover:scale-110 shadow-md outline-none focus:ring-2 focus:ring-coffee-400 focus:ring-offset-2"
